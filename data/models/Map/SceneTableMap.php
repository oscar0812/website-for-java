...
class SceneTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Text', 'Placement', ),
        self::TYPE_CAMELNAME     => array('id', 'text', 'placement', ),
        self::TYPE_COLNAME       => array(SceneTableMap::COL_ID, SceneTableMap::COL_TEXT, SceneTableMap::COL_PLACEMENT, ),
        self::TYPE_FIELDNAME     => array('id', 'text', 'placement', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Text' => 1, 'Placement' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'text' => 1, 'placement' => 2, ),
        self::TYPE_COLNAME       => array(SceneTableMap::COL_ID => 0, SceneTableMap::COL_TEXT => 1, SceneTableMap::COL_PLACEMENT => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'text' => 1, 'placement' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('text', 'Text', 'VARCHAR', true, 16384, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SceneTableMap::COL_TEXT);
