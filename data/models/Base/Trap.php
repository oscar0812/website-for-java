 ...
 */
abstract class Trap implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TrapTableMap';
    ...
    /**
     * Initializes internal state of Base\Trap object.
     */
    ...
    /**
     * Compares this with another <code>Trap</code> instance.  If
     * <code>obj</code> is an instance of <code>Trap</code>, delegates to
     * <code>equals(Trap)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Trap The current object, for fluid interface
     */
     ...
     * @return $this|\Trap The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TrapTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[TrapTableMap::COL_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[TrapTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setDamage($v)
    {
        ...
        if ($this->damage !== $v) {
            $this->damage = $v;
            $this->modifiedColumns[TrapTableMap::COL_DAMAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TrapTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TrapTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TrapTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TrapTableMap::translateFieldName('Damage', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = TrapTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Trap'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTrapQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTrapQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TrapTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TrapTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TrapTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TrapTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TrapTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(TrapTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(TrapTableMap::COL_DAMAGE)) {
    ...
    {
        $pos = TrapTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Trap'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Trap'][$this->hashCode()] = true;
        $keys = TrapTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    {
        $criteria = new Criteria(TrapTableMap::DATABASE_NAME);

        if ($this->isColumnModified(TrapTableMap::COL_ID)) {
            $criteria->add(TrapTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TrapTableMap::COL_NAME)) {
            $criteria->add(TrapTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(TrapTableMap::COL_DESCRIPTION)) {
            $criteria->add(TrapTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(TrapTableMap::COL_DAMAGE)) {
            $criteria->add(TrapTableMap::COL_DAMAGE, $this->damage);
        }
    ...
    {
        $criteria = ChildTrapQuery::create();
        $criteria->add(TrapTableMap::COL_ID, $this->id);
     ...
     * If this ChildTrap is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTrap The current object (for fluent API support)
     */
     ...
     * @return ObjectCollection|ChildScene[] List of ChildScene objects
     */
    public function getScenesJoinItem(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSceneQuery::create(null, $criteria);
     ...
     * @return ObjectCollection|ChildScene[] List of ChildScene objects
     */
    public function getScenesJoinSceneRelatedByParentSceneId(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSceneQuery::create(null, $criteria);
        $query->joinWith('SceneRelatedByParentSceneId', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(TrapTableMap::DEFAULT_STRING_FORMAT);
    }
