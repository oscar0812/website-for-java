...
abstract class Scene implements ActiveRecordInterface
{
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[SceneTableMap::COL_TEXT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SceneTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SceneTableMap::translateFieldName('Placement', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SceneTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SceneTableMap::COL_TEXT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SceneTableMap::COL_TEXT)) {
            $criteria->add(SceneTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(SceneTableMap::COL_PLACEMENT)) {
